export const searchIndex = [
  {
    ...
    "headers": [
      ...
      },
      {
        ...
        "slug": "какои-максимальныи-размер-cookie",
      ...
      {
        "level": 3,
        "title": "Что такое статическая и динамическая типизации?",
        "slug": "что-такое-статическая-и-динамическая-типизации",
      ...
      },
      {
        ...
        "slug": "как-клиент-взаимодеиствует-с-сервером",
